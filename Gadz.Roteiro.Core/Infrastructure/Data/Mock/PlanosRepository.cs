...
namespace Gadz.Roteiro.Core.Infrastructure.Data.Mock {
    ...
    internal class PlanosRepository : IPlanosRepository {
        ...
        private static List<IPlano> LoadCache() {
            ...
            var plano1 = new Plano(Identity.Create()) { Nome = "Plano 1", Descricao = "Clientes que gastam até 100 por mês", Preco = 120L };
            var plano2 = new Plano(Identity.Create()) { Nome = "Plano 1", Descricao = "Plano 2", Preco = 120L };
            var plano3 = new Plano(Identity.Create()) { Nome = "Plano 1", Descricao = "Plano 3", Preco = 120L };
            var plano4 = new Plano(Identity.Create()) { Nome = "Plano 1", Descricao = "Plano 4", Preco = 120L };
            var plano5 = new Plano(Identity.Create()) { Nome = "Plano 1", Descricao = "Plano 5", Preco = 120L };
        ...
        public IEnumerable<IPlano> GetAllOf(IInteracao entity) {
            return _cache;
        }
    }
}
